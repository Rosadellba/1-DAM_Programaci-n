...
USE `incidencias`;
CREATE USER 'rosa'@'%' IDENTIFIED BY '12345';
GRANT ALL PRIVILEGES ON incidencias.* TO 'rosa'@'%';
FLUSH PRIVILEGES;
-- --------------------------------------------------------
...
INSERT INTO `pendientes` (`Codigo`, `Estado`, `Puesto`, `Problema`) VALUES
('26/5/2024-10:39-1', 'pendiente', 4, 'fewfew');
